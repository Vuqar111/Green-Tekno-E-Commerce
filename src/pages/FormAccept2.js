      ...
      <div className="ordersection">
        <div className="form">
          ...
          <form>
            ...
            <div className="form-group">
              <div>
                <label for="name">Şəxsiyyət vəsiqəsinin FİN kodu</label>
                <input type="text" className="form-control" id="name" />
              </div>

              <div>
                <label for="surname">Şəhər telefon nömrəsi</label>
                <input type="text" className="form-control" id="surname" />
              </div>
            </div>
        ...
        <div className="rightform">
          ...
          <h4>
            İlkin ödəniş: <span>60 $</span>
          </h4>
          <h4>
            Aylıq ödəniş: <span>60 $</span>
          </h4>
          <h4>
